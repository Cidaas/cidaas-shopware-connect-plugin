...
namespace Cidaas\OauthConnect\Oauth\HttpClient;
 ...
 *
 * <code>
 *  $guzzle = new Cidaas\OauthConnect\Oauth\HttpClient\Guzzle( new GuzzleHttp\Client(), [
 *      'verify'  => '/path/to/your/certificate.crt',
 *      'headers' => [ 'User-Agent' => '..' ]
 *      // 'proxy' => ...
 *  ]);
 *
 *  $adapter = new Cidaas\OauthConnect\Oauth\Provider\Github( $config, $guzzle );
 *
