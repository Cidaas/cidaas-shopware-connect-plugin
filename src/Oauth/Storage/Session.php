...
use Cidaas\OauthConnect\Oauth\Exception\RuntimeException;

/**
 * Cidaas\OauthConnect\Oauth storage manager
 */
class Session implements StorageInterface
{
    ...
    */
    public function __construct()
    {
        ...
        if (headers_sent()) {
            // phpcs:ignore
            throw new RuntimeException('HTTP headers already sent to browser and Oauth won\'t be able to start/resume PHP session. To resolve this, session_start() must be called before outputing any data.');
        }
