...
namespace Cidaas\OauthConnect\Oauth\Adapter;

use Cidaas\OauthConnect\Oauth\Exception\Exception;
use Cidaas\OauthConnect\Oauth\Exception\InvalidApplicationCredentialsException;
use Cidaas\OauthConnect\Oauth\Exception\AuthorizationDeniedException;
use Cidaas\OauthConnect\Oauth\Exception\InvalidOauthTokenException;
use Cidaas\OauthConnect\Oauth\Exception\InvalidAccessTokenException;
use Cidaas\OauthConnect\Oauth\Data;
use Cidaas\OauthConnect\Oauth\HttpClient;
use Cidaas\OauthConnect\Oauth\Thirdparty\OAuth\OAuthConsumer;
use Cidaas\OauthConnect\Oauth\Thirdparty\OAuth\OAuthRequest;
use Cidaas\OauthConnect\Oauth\Thirdparty\OAuth\OAuthSignatureMethodHMACSHA1;
use Cidaas\OauthConnect\Oauth\Thirdparty\OAuth\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
    ...
    */
     ...
     * @throws \Cidaas\OauthConnect\Oauth\Exception\HttpClientFailureException
     * @throws \Cidaas\OauthConnect\Oauth\Exception\HttpRequestFailedException
    ...
    *
    * @return \Cidaas\OauthConnect\Oauth\Data\Collection
    * @throws InvalidOauthTokenException
    */
