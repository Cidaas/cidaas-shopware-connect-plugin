...
use Cidaas\OauthConnect\Oauth\Exception\InvalidAuthorizationStateException;
use Cidaas\OauthConnect\Oauth\Exception\InvalidAuthorizationCodeException;
...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
    ...
    * RFC6749 and OAuth specifications, Cidaas\OauthConnect\Oauth will consider any HTTP
