import './cidaas-open-auth-client-listing-page.scss';
import template from './cidaas-open-auth-client-listing-page.html.twig';

const { Component, Context, Data, Mixin } = Shopware;
const { Criteria } = Data;

Component.register('cidaas-open-auth-client-listing-page', {
    template,
