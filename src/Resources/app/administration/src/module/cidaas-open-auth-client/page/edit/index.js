import template from './cidaas-open-auth-client-edit-page.html.twig';

const { Component, Context, Mixin } = Shopware;

Component.register('cidaas-open-auth-client-edit-page', {
    template,
    ...
    methods: {
        ...
        onConfirmDelete() {
            ...
            return this.clientRepository
                ...
                .then(() => {
                    this.$router.push({ name: 'cidaas.open.auth.client.settings' });
                }).catch(exception => {
                    this.isLoading = false;
                    const clientName = this.client.name;
                    this.createNotificationError({
